...
class ArbitratedRouter(ClassifierDietRouter):
    ...
    def __init__(
        ...
        # Meme composant que A17, pour que l'ecart entre les deux mesure DIET
        # et non deux implementations differentes du meme classifieur.
    ...
    def _enumerated(self, definition: ToolDefinition, name: str, utterance: str) -> Any:
        ...
        return self._enumerations.value(definition, name, utterance)
